        ...
        <div class="row justify-content-center">
            <div class="col-lg-12">
                <div class="card border-0 shadow-sm">
                    ...
                    <form class="card-body" method="post" action="product.php?mode=<?= $mode ?>&id=<?= $id ?>" enctype="multipart/form-data">
                        <?php if (!empty($error)) { ?>
                        ...
                        <div class="mt-4 pt-3 border-top text-end">
                            <button type="submit" name="btn_submit" class="btn btn-gold btn-sm rounded-pill px-4">
                                <i class="bi bi-check-circle me-1"></i> <?= ($mode == 'edit') ? 'Update Product' : 'Save Product' ?>
                            </button>
